...
module.exports = {
	...
	get: function (reference) {
		return component.reference('grid', reference);
	},
	/**
	 * * Sample Usage:
	...
	setup: function (reference, storeUrl, filters = {}) {
		var grid = component.reference('grid', reference),
			paging = grid.down('pagingtoolbar'),
			dataStore = store.create(storeUrl, filters, grid);
	...
	getSelection: function (reference) {
		return component.reference('grid', reference).getSelectionModel().getLastSelected();
	},
	/**
	 * * Sample Usage:
	...
	getStore: function (reference) {
		return component.reference('grid', reference).getStore();
	},
	/**
	 * * Sample Usage:
	...
	reload: function (reference) {
		component.reference('grid', reference).getStore().load();
	}
};