const grid = {
	...
	get: function (reference) {
		return self.component.reference('grid', reference);
	},
	/**
	 * * Sample Usage:
	...
	setup: function (reference, storeUrl, filters = {}) {
		var grid = self.component.reference('grid', reference),
			paging = grid.down('pagingtoolbar'),
			dataStore = self.store.create(storeUrl, filters, grid);
	...
	getSelection: function (reference) {
		return self.component.reference('grid', reference).getSelectionModel().getLastSelected();
	},
	/**
	 * * Sample Usage:
	...
	getStore: function (reference) {
		return self.component.reference('grid', reference).getStore();
	},
	/**
	 * * Sample Usage:
	...
	reload: function (reference) {
		self.component.reference('grid', reference).getStore().load();
	}
};
