const grid = {
	...
	setup: function (reference, storeUrl, filters = {}) {
		var grid = this.component.reference('grid', reference),
			paging = grid.down('pagingtoolbar'),
			dataStore = this.store.create(storeUrl, filters, grid);
	...
	getSelection: function (reference) {
		return this.component.reference('grid', reference).getSelectionModel().getLastSelected();
	},
	/**
	 * * Sample Usage:
	...
	getStore: function (reference) {
		return this.component.reference('grid', reference).getStore();
	},
	/**
	 * * Sample Usage:
	...
	reload: function (reference) {
		this.component.reference('grid', reference).getStore().load();
	}
};
